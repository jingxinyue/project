...
class TimeScaleDraw: public QwtScaleDraw//自定义横轴时间格式化绘制类，用于动态展示分秒刻度
{
public:
...
class Background: public QwtPlotItemhu//画布渐变背景绘制类
{
public:
    Background()
    {
...
class MainCurve: public QwtPlotCurve//业务数据曲线绘制对象
{
public:
