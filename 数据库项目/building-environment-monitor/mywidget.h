...
public:
    ...
    char *phone_num,*phone_data;  //短信告警使用的目标手机号
    int Sim_state;
...
private:
    ...
    double  tempAlarmsValue;//温度上限告警阈值
    double  humiAlarmsValue;//湿度上限告警阈值
    double  tempAlarmsValueBlue;//温度下限告警阈值
    double  humiAlarmsValueBlue;//湿度下线告警阈值
